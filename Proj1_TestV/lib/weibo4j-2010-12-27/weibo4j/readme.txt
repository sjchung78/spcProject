...
9、因friendsstatuses和followstatuses不支持page参数，改为cursor参数。
10、关闭log输出。
...
statuses/repost_timeline 返回一条原创微博的最新n条转发微博信息
statuses/repost_by_me 返回用户转发的最新n条微博信息
users/hot 获取系统推荐用户 
...
Statuses/comment/destroy batch 批量删除当前用户的微博评论信息 
...
account/update_profile 更改资料 方法名：User updateProfile(String name, String email, String url, String location, String 
